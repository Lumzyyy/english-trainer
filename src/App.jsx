...
import { Moon, Sun, BookOpen, PenLine, GitBranch, FlaskConical, Table2, Map } from 'lucide-react'
    ...
    <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingBottom: 0, paddingTop: 12 }}>
            <div>
              ...
              <span style={{ fontSize: '.7rem', color: 'var(--text3)', marginLeft: 8, background: 'var(--bg2)', padding: '2px 6px', borderRadius: 4, letterSpacing: '.03em' }}>Data/IA</span>
            </div>
          ...
          {/* Tab bar */}
          <nav style={{ display: 'flex', gap: 2, marginTop: 8, overflowX: 'auto', scrollbarWidth: 'none' }}>
            {TABS.map(t => {
              const Icon = t.icon
              ...
              return (
                <button key={t.id}
                  ...
                  style={{
                    ...
                    whiteSpace: 'nowrap', transition: 'all .15s', borderRadius: '4px 4px 0 0',
                  }}>
                  <Icon size={13} />
                  {t.shortLabel}
                </button>
